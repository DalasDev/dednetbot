...
bot.on('guildMemberAdd', member => {
    member.guild.channels.get('633756167600078849').send(':purple_heart: **' + member.user.username + '**, зашел на сервер! :purple_heart:');
});

bot.on('guildMemberRemove', member => {
    member.guild.channels.get('633756167600078849').send(':broken_heart: **' + member.user.username + '**, покинул нас! :broken_heart:');
});
